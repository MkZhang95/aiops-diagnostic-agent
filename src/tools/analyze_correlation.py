...
def make_analyze_correlation_tool(simulator: DataSimulator):
    """Create an analyze_correlation tool bound to one diagnostic data source."""
    ...
    def analyze_correlation(
        ...
        """
        base = simulator.query_metrics(base_metric, 0, 3600)
        ...
        missing = []
        for name in names:
            other = simulator.query_metrics(name, 0, 3600)
